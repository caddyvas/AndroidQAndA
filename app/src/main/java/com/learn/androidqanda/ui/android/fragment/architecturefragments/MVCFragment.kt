...
class MVCFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        activity?.actionBar?.title = "MVC Pattern"
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        textViewTitle.text = "MVC PATTERN"
        val imgView = view.findViewById<ImageView>(R.id.fragmentArchitectureImageView)
        imgView.setImageResource(R.drawable.mvc_architecture)
        ...
        textViewContent.text = resources.getText(R.string.architecture_mvc)
