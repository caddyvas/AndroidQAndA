...
class MVVMFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        activity?.actionBar?.title = "MVVM Pattern"
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        imgView.setImageResource(R.drawable.mvvm_architecture)
        textViewTitle.text = "MVVM PATTERN"
        ...
        textViewContent.text = resources.getText(R.string.architecture_mvvm)
